          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.facebook.com/QiraatHub/" className="text-gray-600 hover:text-gray-900" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.instagram.com/qiraathub/" className="text-gray-600 hover:text-gray-900" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://x.com/QiraatHub" className="text-gray-600 hover:text-gray-900" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
              ...
              <form className="space-y-2">
                ...
                <button 
                  type="submit" 
                  className="w-full px-4 py-2 bg-gray-900 text-white rounded-md hover:bg-gray-800 transition duration-200"
                >
                  Subscribe
                </button>
              </form>
