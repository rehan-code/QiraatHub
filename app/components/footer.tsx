        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-10 mt-4">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-600 hover:text-theme_primary transition-all duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-theme_primary transition-all duration-300"></span>
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-600 hover:text-theme_primary transition-all duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-theme_primary transition-all duration-300"></span>
                  About
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-600 hover:text-theme_primary transition-all duration-300 flex items-center gap-2 group">
                  <span className="w-0 group-hover:w-2 h-0.5 bg-theme_primary transition-all duration-300"></span>
                  Contact
                </Link>
              </li>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600">Subscribe to our newsletter for updates and insights.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <a 
                ...
                className="text-gray-600 hover:text-theme_primary transition-all duration-300 flex items-center gap-3 group"
              >
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  className="text-gray-600 hover:text-red-600 transform hover:scale-110 transition-all duration-300" 
                  aria-label="YouTube" 
                  target="_blank" 
                ...
                <a 
                  ...
                  className="text-gray-600 hover:text-pink-600 transform hover:scale-110 transition-all duration-300" 
